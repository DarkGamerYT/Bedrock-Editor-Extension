        ...
        uiSession.actionManager.createAction(
            {
                ...
                onExecute: async () => {
                    ...
                    const blocks: { typeId: string, amount: number }[] = [];
                    await Editor.executeLargeOperation(
                        ...
                        () => {
                            ...
                            const newSettings = Editor.bindDataSource( newPane, {} as any );

                            const sortedBlocks = blocks.sort((a, b) => b.amount - a.amount);
