...
export default ( uiSession ) => {
    ...
    pane.addBool(
        ...
        "face",
        {
            ...
            onChange: ( _obj, _property, _oldValue, _newValue ) => {
                if (uiSession.scratchStorage === undefined) return console.error( "Cylinder storage was not initialized." );
    ...
    const onExecuteBrush = () => {
        if (!uiSession.scratchStorage?.previewSelection) return console.error( "Cylinder storage was not initialized." );
